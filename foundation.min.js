...
// Skapa en <span> tagg och lägg till all text från barnet från de två andra div-elementen. 
  const span = document.createElement('span');
    span.innerText = document.querySelectorAll('body > #page-container > div > div > div:first-child');
// Rensa bort allt innehåll från <body> elementet
    document.querySelectorAll('body > #page-container > div > div > div:first-child').innerHTML = '';  
// Lägg till <span> elementet som child till <body> elementet
    document.querySelectorAll('body > #page-container > div > div > div:first-child').appendChild(span);}
// Kör funktionen cleanHTML när sidan har laddats 
    window.addEventListener('load', cleanHTML);
...
var spans = document.querySelectorAllAll('span');
